...
export default function Home() {
  return (
    <div>
      <Header />
      {/* ayush captain try to keep the class names descriptive and distinct so that css files dont conflict*/}
      <div className="home-section-1">
        <div className="home-section-1-heading">
          Different Use Cases, <br /> Awesome Benefits.
        </div>
        <p>
          All Fleek products are built on the underlying protocols that power
          the new Open Web (Internet Computer, IPFS, Textile, Filecoin.
...
>>>>>>> 4a0c4e56fbe24d71ebad5b80c8ef6cb270d37f0c
            </div>
            <div className="card-heading">IPFS Hosting</div>
            <div className="btn">Learn More</div>
          </div>
